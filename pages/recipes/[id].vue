...
<div class="p-recipe-view">
  ...
  <MyTitle el="h3" size="small" bold="bold">{{ recipes.recipe_name }}</MyTitle>
</div>
  ...
  <div class="grid">
    ...
    <div class="grid__right">
      <MyIcon name="fork knife" color="orange" stroke="white" size="regular"></MyIcon>
    <MyTitle el="h4" weight="bold" size="small" bold="bold">- Listes des ingrédients de la recette :</MyTitle>
        <ul>
